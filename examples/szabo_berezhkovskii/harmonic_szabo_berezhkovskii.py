...
plt.savefig("harmonic_szabo_berezhkovskii_files/potential_x.png")
fig, ax, _, _ = vis.plot_projection_y()
plt.savefig("harmonic_szabo_berezhkovskii_files/potential_y.png")
...
vis.scatter_traj(sim.traj, "harmonic_szabo_berezhkovskii_files/traj.png", every=50)
vis.scatter_traj_projection_x(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_x.png", every=50)
vis.scatter_traj_projection_y(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_y.png", every=50)
vis.animate_traj(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_movie", every=200)
vis.animate_traj_projection_x(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_movie", every=200)
vis.animate_traj_projection_y(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_movie", every=200)
