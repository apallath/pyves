...
vis.scatter_traj_projection_x(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_x.png")
vis.animate_traj(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_movie", every=50)
vis.animate_traj_projection_x(sim.traj, "harmonic_szabo_berezhkovskii_files/traj_movie", every=50)
